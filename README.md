...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-oompabase-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-oompabase-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-oompabase
# for installing globally
pixi global install r-oompabase
```
...
It is possible to list all of the versions of `r-oompabase` available on your platform:
...
```
pixi search r-oompabase --channel conda-forge
```
